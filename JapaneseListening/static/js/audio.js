...
//    window.logAvailableVoices(); // 打印当前可用语音（可注释掉）
...
window.readAllSceneText = function(dialogList, onComplete = () => {}) {
    ...
    function speakNext() {
        ...
        if (line.speaker === "B" ||line.speaker === "Professor" ||line.speaker === "CEO" ||line.speaker === "Doctor" ||line.speaker === "Ambassador") {
            selectedVoice = voices.find(v => (v.name === "Otoya" || v.name === "Hattori") && v.lang === "ja-JP"); // 男声
        } else if (line.speaker === "A" ||line.speaker === "Narrator" ||line.speaker === "Student" ||line.speaker === "Reporter" ||line.speaker === "CFO" ||line.speaker === "Critic" ||line.speaker === "Client") {
